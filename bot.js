...
const adminprefix = "%";
const devs = ['283580465862934539','404142491344830484','425003158167748629'];
...
client.on('guildMemberAdd', member => {
    ...
    var channel =member.guild.channels.find('name', 'hrthrthtrhtrh')
    if (!channel) return;
